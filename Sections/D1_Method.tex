...
\begin{equation}
    \begin{split}
        &R-\textcolor{CarboxylOrange}{COOH}+\textcolor{HydroxylBlue}{HO}-R'\rightarrow\\
        &R-\textcolor{CarboxylOrange}{CO}\textcolor{HydroxylBlue}{O}-R'+\textcolor{CarboxylOrange}{H}-\textcolor{CarboxylOrange}{O}-\textcolor{HydroxylBlue}{H}
    \end{split}
    \label{eq:4}
\end{equation}
...
\begin{center}
    ...
    \includegraphics[width=.48\textwidth]{MonomersGroupHighlighting}
...
\begin{center}
    \captionsetup{format=custom,width=0.4\textwidth,skip=0pt}
    \includegraphics[width=.48\textwidth]{Polyesterification}
...
\begin{center}
    \captionsetup{format=custom,width=0.4\textwidth,skip=0pt}
    \includegraphics[width=.48\textwidth]{PolymersGroupHighlighting}
    \captionof{figure}{\footnotesize{Skeletal diagram}}
    \label{fig:IntroductionPolyesterification}
\end{center}
...
\begin{figure*}[htb]
    ...
    \captionof{figure}{\footnotesize{This is a diagram of the reaction between the various elected monomers.}}
    \label{fig:SimpleReactionOverview}
\end{figure*}

\subsection{Target Variable Selected}
