...
Polymerised content could be an indicator of the crosslink density of 
...
Additionally, reaction times for rigid solid thermoset materials are on the
 order of \textcolor{purple}{days} when uncatalyzed \autocite{Trenkel2008} (catalysis commonly
